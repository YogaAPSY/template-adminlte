				...
				<div class="col-12 col-sm-6 col-md-3">
					<div class="info-box">
						...
						<div class="info-box-content">
							<span class="info-box-text">Trafiktot</span>
						...
						<div class="card-body p-0">
							<div class="table-responsive">
								<table class="table m-0">
									...
									<tbody>
										<tr>
											<td><a href="<?= base_url('assets/adminLTE/') ?>pages/examples/invoice.html">OR9842</a></td>
										...
										<tr>
											<td><a href="<?= base_url('assets/adminLTE/') ?>pages/examples/invoice.html">OR1848</a></td>
										...
										<tr>
											<td><a href="<?= base_url('assets/adminLTE/') ?>pages/examples/invoice.html">OR7429</a></td>
											<td>iPhone 6 Plus</td>
